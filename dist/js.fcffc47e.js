...
var Todo = /*#__PURE__*/function () {
  ...
  _createClass(Todo, [{
    ...
    value: function removeTodo(text) {
      var filter = this.todos.filter(function (a) {
        return a != text;
      });
      this.todoEl && this.todoEl.removeChild(Todo.removeTodoEl(text, this.todoEl));
      this.todos = filter;
    } //metoda obslugi przycisku usuń

  }, {
    key: "delButtonHandler",
    value: function delButtonHandler() {
      var buttons = document.getElementsByTagName("button");
      buttons = Array.from(buttons);
      var filteredButtons = buttons.filter(function (a) {
        return a.textContent == "X";
      });
      filteredButtons.forEach(function (element) {
    ...
    key: "marlButtonhandler",
    value: function marlButtonhandler() {
      var buttons = document.getElementsByTagName("button");
      buttons = Array.from(buttons);
      var filteredButtons = buttons.filter(function (a) {
        return a.textContent == "Gotowe";
      });
      filteredButtons.forEach(function (element) {
        element.onclick = function (e) {
    ...
    key: "removeTodoEl",
    value: function removeTodoEl(text, todoEl) {
      var childs = todoEl && Array.from(todoEl.childNodes);
      var item = childs.find(function (a) {
        return a.innerText === text;
      });
      return item;
    }
  }]);
